...
const ReusableCard = ({ model, categories, imgUrl }) => {
  return (
    <>
      <div className="flex flex-col mb-8 sm:px-2 lg:px-8 ">
        {categories ? (
          <>
            <div className="bg-[#d9d9d9] py-2 md:py-8 rounded-3xl md:px-8 ">
              <div className="text-left flex justify-around items-center md:flex md:w-[95%]">
                ...
                <div>
                  <h2 className="md:text-lg font-semibold md:-my-6">
                    {categories.name}
                  </h2>
          ...
          <>
            <div className="bg-[#d9d9d9] mt-6 pt-20 rounded-3xl flex justify-center md:w-[293px] md:h-[244px]">
              <Image
                src={imgUrl}
                height={300}
                width={380}
            ...
            <Link href="/" className="uppercase text-md mt-4 font-semibold">
              {model}
            </Link>
          </>
        )}
